...
/**
 * Provide PrimeFaces {@link LazyDataModel} for {@link Roles}
 */
@Named
@ConversationContextScoped
public class RolesLazyDataModel extends GenericLazyDataModel<Roles, Integer, RolesSearchForm> {
    private static final long serialVersionUID = 1L;

    @Inject
    public RolesLazyDataModel(RolesRepository rolesRepository, RolesController rolesController, RolesSearchForm rolesSearchForm,
            RolesExcelExporter rolesExcelExporter) {
        super(rolesRepository, rolesController, rolesSearchForm, rolesExcelExporter);
    }
}